...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PublicationsMajeur.annee'
        db.alter_column('annuaire_publicationsmajeur', 'annee', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'PublicationsMajeur.annee'
        db.alter_column('annuaire_publicationsmajeur', 'annee', self.gf('django.db.models.fields.IntegerField')(null=True))
