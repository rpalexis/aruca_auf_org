...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chercheur.axe'
        db.add_column('annuaire_chercheur', 'axe',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1),
                      keep_default=False)


        # Changing field 'These.etablissement'
        db.alter_column('annuaire_these', 'etablissement', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'These.directeur'
        db.alter_column('annuaire_these', 'directeur', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'These.titre'
        db.alter_column('annuaire_these', 'titre', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'These.annee'
        db.alter_column('annuaire_these', 'annee', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Chercheur.axe'
        db.delete_column('annuaire_chercheur', 'axe')


        # Changing field 'These.etablissement'
        db.alter_column('annuaire_these', 'etablissement', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'These.directeur'
        db.alter_column('annuaire_these', 'directeur', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'These.titre'
        db.alter_column('annuaire_these', 'titre', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'These.annee'
        db.alter_column('annuaire_these', 'annee', self.gf('django.db.models.fields.IntegerField')(default=1))
