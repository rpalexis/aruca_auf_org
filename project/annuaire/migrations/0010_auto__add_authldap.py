...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AuthLDAP'
        db.create_table('annuaire_authldap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('ldap_hash', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('date_modification', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('annuaire', ['AuthLDAP'])


    def backwards(self, orm):
        # Deleting model 'AuthLDAP'
        db.delete_table('annuaire_authldap')
    ...
    models = {
        ...
        'annuaire.equipe': {
            ...
            'autres': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'axe': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
