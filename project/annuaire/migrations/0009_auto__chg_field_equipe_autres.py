...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equipe.autres'
        db.alter_column('annuaire_equipe', 'autres', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Equipe.autres'
        db.alter_column('annuaire_equipe', 'autres', self.gf('django.db.models.fields.CharField')(max_length=255))
