...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chercheur.stagiaire'
        db.alter_column('annuaire_chercheur', 'stagiaire', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Chercheur.doctorants'
        db.alter_column('annuaire_chercheur', 'doctorants', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Chercheur.stagiaire'
        db.alter_column('annuaire_chercheur', 'stagiaire', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Chercheur.doctorants'
        db.alter_column('annuaire_chercheur', 'doctorants', self.gf('django.db.models.fields.IntegerField')())
