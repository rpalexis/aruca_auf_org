...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicationsMajeurEquipe'
        db.create_table('annuaire_publicationsmajeurequipe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chercheur', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publications', to=orm['annuaire.Equipe'])),
            ...
            ('annee', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('nb_pages', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('annuaire', ['PublicationsMajeurEquipe'])

        # Adding model 'Equipe'
        db.create_table('annuaire_equipe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('etablissement_autre_pays', self.gf('django.db.models.fields.related.ForeignKey')(related_name='etablissement_autre_pays_equipe', db_column='etablissement_autre_pays', to_field='code', to=orm['references.Pays'], blank=True, null=True)),
            ('intitule', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('axe', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('date_creation', self.gf('django.db.models.fields.DateField')()),
            ('date_evaluation', self.gf('django.db.models.fields.DateField')()),
            ...
            ('courriel', self.gf('django.db.models.fields.EmailField')(max_length=128)),
            ...
            ('prof', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('maitre', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('assistant', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('chercheur', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('autres', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('enseignant', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('doctorants', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('stagiaire', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('complement', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal('annuaire', ['Equipe'])


        # Changing field 'Chercheur.courriel'
        db.alter_column('annuaire_chercheur', 'courriel', self.gf('django.db.models.fields.EmailField')(default=0, max_length=128))

    def backwards(self, orm):
        # Deleting model 'PublicationsMajeurEquipe'
        db.delete_table('annuaire_publicationsmajeurequipe')

        # Deleting model 'Equipe'
        db.delete_table('annuaire_equipe')


        # Changing field 'Chercheur.courriel'
        db.alter_column('annuaire_chercheur', 'courriel', self.gf('django.db.models.fields.EmailField')(max_length=128, null=True))
    ...
    models = {
        'annuaire.chercheur': {
            ...
            'axe': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            ...
            'doctorants': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'stagiaire': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        'annuaire.equipe': {
            'Meta': {'ordering': "['nom', 'prenom', 'langue']", 'object_name': 'Equipe'},
            'actif': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'afficher_courriel': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'assistant': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'autres': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'axe': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'chercheur': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'communication': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'complement': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'courriel': ('django.db.models.fields.EmailField', [], {'max_length': '128'}),
            'date_creation': ('django.db.models.fields.DateField', [], {}),
            'date_evaluation': ('django.db.models.fields.DateField', [], {}),
            'date_mod': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_pub': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'doctorants': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'enseignant': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'equipement': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'etablissement': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'etablissement_autre_nom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'etablissement_autre_pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'etablissement_autre_pays_equipe'", 'db_column': "'etablissement_autre_pays'", 'to_field': "'code'", 'to': "orm['references.Pays']", 'blank': 'True', 'null': 'True'}),
            'genre': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intitule': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'laboratoire': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'langue': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'maitre': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'mots_cles': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'partenaires': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'prenom': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            ...
            'prof': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'publicationsAutre': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'publicationsColloc': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'publicationsInternational': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'site': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'annuaire.publicationsmajeur': {
            ...
            'annee': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'annuaire.publicationsmajeurequipe': {
            'Meta': {'object_name': 'PublicationsMajeurEquipe'},
            'annee': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'auteurs': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'chercheur': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publications'", 'to': "orm['annuaire.Equipe']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nb_pages': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'revue': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'titre': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        ...
        'annuaire.these': {
            ...
            'directeur': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'etablissement': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
