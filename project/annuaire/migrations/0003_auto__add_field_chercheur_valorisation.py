...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chercheur.valorisation'
        db.add_column('annuaire_chercheur', 'valorisation',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chercheur.valorisation'
        db.delete_column('annuaire_chercheur', 'valorisation')
