...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equipe.enseignant'
        db.alter_column('annuaire_equipe', 'enseignant', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Equipe.date_creation'
        db.alter_column('annuaire_equipe', 'date_creation', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Equipe.stagiaire'
        db.alter_column('annuaire_equipe', 'stagiaire', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Equipe.date_evaluation'
        db.alter_column('annuaire_equipe', 'date_evaluation', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Equipe.doctorants'
        db.alter_column('annuaire_equipe', 'doctorants', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Equipe.partenaires'
        db.alter_column('annuaire_equipe', 'partenaires', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Equipe.enseignant'
        db.alter_column('annuaire_equipe', 'enseignant', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Equipe.date_creation'
        db.alter_column('annuaire_equipe', 'date_creation', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'Equipe.stagiaire'
        db.alter_column('annuaire_equipe', 'stagiaire', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Equipe.date_evaluation'
        db.alter_column('annuaire_equipe', 'date_evaluation', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'Equipe.doctorants'
        db.alter_column('annuaire_equipe', 'doctorants', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Equipe.partenaires'
        db.alter_column('annuaire_equipe', 'partenaires', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'annuaire.equipe': {
            ...
            'date_evaluation': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_mod': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_pub': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'doctorants': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'enseignant': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'equipement': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'etablissement': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'etablissement_autre_nom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
